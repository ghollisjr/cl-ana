...
combination.  Note that no safety checks are performed, so use
reasonable values.  Also note that for r=0, one evaluation of the body
is performed with an empty index array."
